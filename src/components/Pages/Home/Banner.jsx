...
const Banner = () => {
    return (
        <div className='bannerBg h-screen nunito'>
            <div>
                <div className='flex relative top-96 md:top-96 lg:top-0 left-4 md:left-0 lg:left-0'>
                ...
                <div className='relative left-4 md:left-0 lg:left-0 bottom-[300px] lg:bottom-[366px] ml-10'>
